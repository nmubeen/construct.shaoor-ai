...
export function ConstructAuthShell({
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-linear-to-b from-[#094136] to-black px-4 py-12">
      ...
      <div className="relative w-full max-w-md rounded-lg border border-[#7D9D76] bg-white/97 p-7 shadow-[0_24px_70px_rgba(3,35,29,.3)] backdrop-blur sm:p-9">
        <Link href="/" className="mb-7 inline-flex items-center gap-3 text-[#094136]">
          <span className="grid size-11 place-items-center rounded-md bg-[#094136] text-lg font-black text-white">S</span>
          <span>
        ...
        <h1 className="mt-2 text-3xl font-bold tracking-tight text-[#094136]">{title}</h1>
